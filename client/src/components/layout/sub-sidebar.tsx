      ...
      {subSidebarOpen && currentSection && currentSection.subItems && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-0 md:left-[68px] top-14 md:top-16 right-0 bottom-0 z-[140] bg-black/10"
          ...
          <motion.aside
            ...
            className="fixed left-0 md:left-[68px] top-14 md:top-16 bottom-0 w-[280px] z-[150] bg-bg-surface border-r border-border flex flex-col shadow-lg"
          >
            {/* ── ヘッダー ── */}
